 ...
 */
//static inline rvm_cfg_t *rvm_cfg_create(rvm_opt_t *opts, create_rmem_layer_f create_rmem)
//{
//   return (rvm_cfg_t*)0xDEADBEEF;
//}
 ...
 */
static inline bool rvm_cfg_destroy(rvm_cfg_t *cfg)
{
    return true;
}
 ...
 */
static inline size_t rvm_get_blk_sz(rvm_cfg_t *cfg)
{
    return 1;
}
 ...
 */
static inline rvm_txid_t rvm_txn_begin(rvm_cfg_t* cfg)
{
    return 1;
}
 ...
 */
static inline bool rvm_txn_commit(rvm_cfg_t* cfg, rvm_txid_t txid)
{
    return true;
}
 ...
 * \returns true for success. false otherwise, sets errno for specific error.
 */
static inline bool check_txn_commit(rvm_cfg_t* cfg, rvm_txid_t txid)
{
    return true;
}

/** Set allocator private information, will be preserved between failures */
static inline bool rvm_set_alloc_data(rvm_cfg_t *cfg, void *alloc_data)
{
    return true;
}

/** Retrieve allocator private information */
static inline void *rvm_get_alloc_data(rvm_cfg_t *cfg)
{
    return NULL;
}
 ...
 */
static inline void *rvm_alloc(rvm_cfg_t *cfg, size_t size)
{
    return malloc(size);
}
 ...
 * \returns A pointer to the beginning of recoverable memory
 */
static inline void *rvm_blk_alloc(rvm_cfg_t* cfg, size_t size)
{
    return malloc(size);
}
 ...
 */
static inline bool rvm_free(rvm_cfg_t* cfg, void *buf)
{
    free(buf);
    return true;
}
 ...
 * \returns true on success, false on error (sets errno)
 */
static inline bool rvm_blk_free(rvm_cfg_t* cfg, void *buf)
{
    free(buf);
    return true;
}
 ...
 */
static inline void *rvm_rec(rvm_cfg_t *cfg)
{
    return NULL;
}
 ...
 *  \returns True on success, false otherwise (sets errno)
 */
static inline bool rvm_set_usr_data(rvm_cfg_t *cfg, void *data)
{
    return true;
}
 ...
 */
static inline void *rvm_get_usr_data(rvm_cfg_t *cfg)
{
    return NULL;
}
